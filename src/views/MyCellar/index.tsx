...
import { GET_MY_CELLAR_DETAILS } from './graphql/myCellarDetails';
...
const MyCellar = () => {
  ...
  const {
    results: myCellarStock,
    loading: loadingMyCellar,
    error: myCellarError,
    refetch: refetchMyCellar,
  } = useExecuteQuery('portalMyCellar', GET_MY_CELLAR);
  const { executor: fetchMyCellarDetails } = useLazyExecuteQuery(GET_MY_CELLAR_DETAILS);
