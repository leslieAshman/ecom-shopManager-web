    ...
    <div className="w-full flex-col border">
      <div className="items-center justify-around flex w-full border-b border-b-gray-300">
        ...
        <div className="flex items-center">
          ...
          <Switcher text="ADSFF" checked={aspect !== undefined} onChange={handleToggleAspectClick} />

          {/* <label className="relative  items-center mb-5 cursor-pointer flex">
            <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Small toggle</span>
            <input type="checkbox" onClick={handleToggleAspectClick} value="" className="sr-only peer" />
        ...
        <CloseBlackIcon className="cursor-pointer" onClick={onClose} />
      </div>
          ...
          <>
            <div className="mx-3 flex flex-col  items-center  h-full">
              ...
              <button
                ...
                className="flex justify-center bg-vine mt-3 hover:bg-gray-400 text-white font-bold py-2 px-4 rounded items-center"
              >
